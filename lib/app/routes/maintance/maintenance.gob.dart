...
import 'package:newhonekapp/app/routes/maintance/maintenance.view.gob.dart';
...
class MaintenanceGobernante extends StatefulWidget {
  const MaintenanceGobernante({super.key});

  @override
  createState() => _MaintenanceGobernante();
}

class _MaintenanceGobernante extends State<MaintenanceGobernante> {
  @override
  void initState() {
    super.initState();
    () async {
      await Future.delayed(Duration.zero);
      await getMaintenancesByGobernante(currentUser.value.parentId != 0 ? currentUser.value.parentId : currentUser.value.id);
    }();
  }
                ...
                children: [
                  ...
                  currentMaintenances.value.isEmpty
                      ? Padding(
                          ...
                          child: Text("Non ci sono manutenzione attive",
                              style: GoogleFonts.roboto(
                                fontSize: 18.0,
                                height: 1.5,
